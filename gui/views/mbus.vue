...
onMounted(async () => {
    const response = await $api.get('/plugin/mbus/data')
...
<style scoped>
h2 { font-size: 1.75rem; line-height: 1.75rem; font-weight: 800; padding: 1rem 0; }
h3 { font-size: 1.5rem; line-height: 1.75rem; font-weight: 800; padding: 1rem 0; }
hr { margin: 1rem 0; }
